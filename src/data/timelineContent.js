...
export const timelineContent = [
	...
	},
	{
		...
		events: [
			createEvent('1月', ['未来中心项目通过招拍挂方式拿地成交。']),
			createEvent('3月', ['未来科学城综合管廊完工投用。'], 'assets/timeline/2014-03.webp'),
			createEvent('9月', [createEventItem('北京师范大学实验小学未来科技城学校、北京师范大学二附中未来科技城学校正式开学。', 'assets/timeline/2014-09.jpg'), createEventItem('', 'assets/timeline/2014-09-2.webp')]),
			createEvent('11月', ['公司与金融街长安（北京）置业有限公司联合拿地，操盘开发建设未来公元项目。'], 'assets/timeline/2014-11.webp'),
			createEvent('12月', [createEventItem('岭上村、北七家村、鲁疃村定向安置房完成交房。', '/assets/timeline/2014-12-lingshang.webp'), createEventItem('', '/assets/timeline/2014-12-beiqijia.webp'), createEventItem('', '/assets/timeline/2014-12-lutuan.webp')]),
		],
	},
	{
		year: 2015,
	...
	},
	{
		...
		title: '蓄势',
		subtitle: '定位明确，使命清晰。',
		events: [createEvent('9月', ['国务院批复《北京加强全国科技创新中心建设总体方案》，明确未来科技城是北京建设全国科技创新中心主平台之一。'], '/assets/timeline/2016-09.webp'), createEvent('这一年起', ['未来科学城集团一级开发、产城空间、产业发展、城市运营、科技金融“五大板块”业务相关公司相继成立。'])],
	},
	{
		year: 2017,
		title: '蝶变',
	...
	},
	{
		...
		title: '绿意',
		subtitle: '低碳基底，生态样板。',
		events: [createEvent('4—11月', [createEventItem('未来中心项目、未来公元项目建成投用。', '/assets/timeline/2021-04.jpg'), createEventItem('', '/assets/timeline/2021-04-2.jpg')]), createEvent('8月', [createEventItem('未来科学城集团牵头编制的首个商务区可持续发展国家标准——《城市可持续发展 商务区可持续发展评价指标》正式获国家标准委立项。')]), createEvent('9月', ['全市首个碳中和主题公园——北京温榆河公园·未来智谷正式开园。'], '/assets/timeline/2021-09.webp')],
	},
	{
		year: 2022,
		title: '精进',
	...
	},
	{
		...
		events: [
			createEvent('5月', [createEventItem('能源谷首个标准厂房项目——未来星科能源谷智造产业园“拿地即实质开工”，未来科学城集团成为昌平区首个获取M1工业用地的园区开发企业。', '/assets/timeline/2023-05.webp'), createEventItem('未来科学城东区首个主题休闲商业街区——未来中心星际花园正式开街。', '/assets/timeline/2023-05-2.webp')]),
	...
	},
	{
		...
		subtitle: '未来所向，城长以新。',
		events: [
			createEvent('1月', ['北京市合成生物制造技术创新中心、中关村合成生物制造产业集聚区正式揭牌。']),
			createEvent('3月', ['未来科学城集团取得昌平区首个机器人产业园项目先期实施地块土地使用权，实现“拿地即实质开工”。'], '/assets/timeline/2024-03.webp'),
			createEvent('4月', ['《未来科学城集团企业文化理念及行为指引体系》确定。'], '/assets/timeline/2024-04.webp'),
	...
	},
	{
		...
		events: [
			...
			createEvent('9月', ['北京温榆河公园·未来智谷二期开园。'], '/assets/timeline/2025-09.jpg'),
			createEvent('10月', ['北京市昌平区合成生物制造产业集群获评全国首个合成生物制造领域国家级中小企业特色产业集群。'], '/assets/timeline/2025-10.jpg'),
			createEvent('11月', [createEventItem('昌平首家山姆会员店正式开业。', '/assets/timeline/2025-11.webp'), createEventItem('未来科学城集团联合开发的北京市首个政府侧区域级能碳监测管理平台正式上线。', '/assets/timeline/2025-11-2.webp')]),
			createEvent('12月', [createEventItem('清华南口国重基地成果转化资金支持体系发布，共建概念验证中心。', '/assets/timeline/2025-12.webp'), createEventItem('未来科学城科技文化交流中心项目正式启动。', '/assets/timeline/2025-12-2.webp'), createEventItem('北京市政府办公厅、国务院国资委办公厅联合印发《关于进一步促进中央企业加快建设未来科学城行动方案（2026-2028年）》。')]),
		],
	},
	{
		year: 2026,
