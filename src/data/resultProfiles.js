...
const traitOptions = {
  '政府机构人员': ['大时代的解题人', '“持久战”的定力担当者', '穿越周期的长期主义者'],
  '集团干部员工': ['韧性生长的实干派', '把理想写进工位的人', '把蓝图铺进现实的人'],
  '入驻企业员工': ['在风口上搬砖的人', '在上升赛道持续深耕的人', '与城共进的合伙人'],
  '区域居民': ['最早一批“押注”的人', '用脚步丈量新城的人', '把“家”字写进未来的人'],
  '关心关注者': ['“弹幕区”的老朋友', '城市生长“云监工”', '“城”长故事的“追更人”']
};

const crossTags = {
  '政府机构人员': ['在空白处落笔', '把蓝图铺开', '与时间对弈', '把格局打开', '把棋局看远'],
  '集团干部员工': ['从零画地图', '把图纸变实景', '把冷板凳坐热', '把硬骨头啃透', '把答案写进未来'],
  '入驻企业员工': ['拼一个未来', '把根扎下去', '与时间做朋友', '把赛道跑宽', '把边界打穿'],
  '区域居民': ['从荒芜看到繁华', '把灯火点亮', '等时间给出答案', '与一座城绑定', '把日子过成诗'],
  '关心关注者': ['听说它、看见它', '保持观望、保持期待', '成为城市“云股东”', '相信“相信”的力量', '等待下一场精彩']
};
