<template>
	<main ref="timelineRoot" class="timeline-view" aria-label="未来科学城时光之旅">
		<Swiper class="timeline-swiper" :initial-slide="initialIndex" :speed="1050" :allow-touch-move="true" @swiper="onSwiperReady" @slide-change="onSlideChange">
			<SwiperSlide v-for="item in timeline" :key="item.year">
				<article class="timeline-slide" :aria-label="`${item.year}年：${item.title}`">
					...
					<div class="timeline-slide__content">
						...
						<section class="events-panel" tabindex="0" :aria-label="`${item.year}年重要事件`">
							<div class="events-track">
								<div v-for="(event, eventIndex) in item.events" :key="`${event.month}-${eventIndex}`" class="event-block">
									<h2 class="event-month" data-event-part>{{ event.month }}</h2>
									<p v-for="line in event.lines" :key="line" class="event-copy" :class="{ 'event-copy--height-34': EVENT_COPY_HEIGHT_34_YEARS.has(item.year) }" data-event-part>
										{{ line }}
									</p>
								</div>
							</div>
					...
					<img v-if="item.planCardImage" class="plan-card-stack" :src="item.planCardImage" :alt="`${item.year}年规划图`" />
				</article>
			</SwiperSlide>
		</Swiper>
		...
		<nav class="year-nav" aria-label="年份导航">
			...
			<button class="year-nav__next" :class="{ 'year-nav__next--result': currentIndex === timeline.length - 1 }" type="button" @click="goNext">
...
const knownTimeline = {
	...
	2010: {
		...
		events: [
			{
				month: '3月',
				lines: ['《未来科技城概念性设计》编制完成', '确定“创新、开放、低碳、人本、共生”', '五大核心理念'],
			},
			{
				month: '5月',
				lines: ['《未来科技城控制性详细规划》获批', '一期划定用地面积10平方公里'],
			},
		],
	},
	2011: {
		...
		events: [
			{
				month: '7月',
				lines: ['土沟村、鲁疃村、北七家村、岭上村', '共计2000余宗宅基地完成拆迁工作'],
			},
			{
				month: '9月',
	...
	2013: {
		...
		events: [
			{
				month: '7月',
				lines: ['《北京未来科技城核心区控制性详细规划》', '获批', '同月，未来科学城路桥建成通车'],
			},
		],
	},
	2014: {
		...
		events: [
			...
			{
				month: '9月',
				lines: ['北京师范大学实验小学未来科技城学校', '北京师范大学二附中未来科技城学校', '正式开学'],
			},
			{
				month: '11月',
				lines: ['公司与金融街长安（北京）置业有限公司', '联合拿地，操盘开发建设未来公元项目'],
			},
			{
				month: '12月',
	...
	2015: {
		...
		events: [
			...
			{
				month: '11月',
				lines: ['集团与保利、华润联合拿地', '合作开发建设保利未来大都汇', '华润未来城市项目'],
			},
		],
	},
	2016: {
		...
		events: [
			{
				month: '9月',
				lines: ['国务院批复《北京加强全国科技创新中心建设总体方案》，明确未来科技城是北京建设全国科技创新中心主平台之一。', '这一年起，集团一级开发、产城空间、产业发展、城市运营、科技金融“五大板块”业务相关公司相继成立'],
			},
		],
	},
	2017: {
		...
		events: [
			{
				month: '2月',
				lines: ['习近平总书记视察北京时强调', '要抓好“三城一区”建设', '努力打造成北京经济发展新高地'],
			},
			{
				month: '3月',
			...
			{
				month: '8月',
				lines: ['北京未来科技城发展集团有限公司更名', '为北京未来科学城发展集团有限公司'],
			},
			{
				month: '10月',
				lines: ['未来科学城滨水公园正式开园'],
	...
	2018: {
		...
		events: [
			...
			{
				month: '10月',
				lines: ['北京未来科学城正式加入', '全球可持续发展标准化城市联盟（ISSCC）'],
			},
			{
				month: '2018年起',
	...
	2019: {
		...
		events: [
			{
				month: '6月',
				lines: ['北京市委市政府正式印发实施', '《未来科学城规划（2017年—2035年）》', '规划面积扩展至170.6平方公里', '构建“两区一心”空间布局和', '“两谷一园”创新格局'],
			},
			{
				month: '9月—12月',
				lines: ['昌平区小沙河村及周边地块棚户区改造', '和环境整治项目宅基地', '生命科学园三期及“北四村”棚户区改造', '和环境整治项目宅基地', '自主腾退签约工作正式启动'],
			},
			{
			...
			{
				month: '12月',
				lines: ['能源转型大会首次在未来科学城举行', '首次明确未来科学城东区将建设具有', '国际影响力的“能源谷”'],
			},
		],
	},
	2020: {
		...
		events: [
			{
				month: '4月',
				lines: ['集团以协议出让方式独立获取', '中关村生命科学园研究型国际医疗产业转化', '平台项目（高博医院）的土地开发使用权'],
			},
			{
				month: '9月',
				lines: ['昌平实验室成功挂牌', '生命科学园及周边10.26平方公里', '纳入北京自由贸易试验区科技创新片区', '未来科学城升级为北京国际科技创新中心', '主平台之一'],
			},
		],
	},
	2021: {
		...
		events: [
			...
			{
				month: '8月',
				lines: ['集团牵头编制的首个商务区', '可持续发展国家标准', '《城市可持续发展商务区可持续发展评价指标》'],
			},
			{
				month: '8月',
	...
	2022: {
		...
		events: [
			{
				month: '6月',
				lines: ['新版未来科学城管委会（生命园管委会）', '三定方案获批，设立未来科学城党工委', '实现提级升格'],
			},
			{
				month: '10月',
			...
			{
				month: '11月',
				lines: ['北京未来科学城智慧城市运行服务中心(IOC)', '目完成竣工备案'],
			},
		],
	},
	2023: {
		...
		events: [
			{
				month: '5月',
				lines: ['能源谷首个标准厂房项目', '未来星科能源谷智造产业园', '“拿地即实质开工”', '集团成为昌平区首个获取M1工业用地的', '园区开发企业'],
			},
			{
				month: '5月',
	...
	2024: {
		...
		events: [
			{
				month: '1月',
				lines: ['北京市合成生物制造技术创新中心', '中关村合成生物制造产业集聚区正式揭牌'],
			},
			{
				month: '3月',
				lines: ['集团取得昌平区首个机器人产业园项目', '先期实施地块土地使用权', '实现“拿地即实质开工”'],
			},
			{
				month: '4月',
			...
			{
				month: '11月',
				lines: ['未来科学城首支政府性产业引导基金', '北京未来科学城国信先进能源及制造产业股权投资基金（有限合伙）成立'],
			},
		],
	},
	2025: {
		...
		events: [
			{
				month: '3月—4月',
				lines: ['未来科学城能源谷首个标准厂房项目', '未来星科能源谷智造产业园一期投用', '二期1#厂房创全区首个', '“多测合一+竣工即交证”项目范例'],
			},
			{
				month: '6月',
				lines: ['“北四村”、创新基地2049户村民回迁', '7978套安置房“零延误”交付', '至此，集团实施的11个村共计213万平方', '米安置房全部竣工交房'],
			},
			{
				month: '7月',
				lines: ['未来科学城首次规模化应用部署', '4亿像素全景智能视频监控系统', '引领国内城市治理场景先河'],
			},
			{
				month: '9月',
			...
			{
				month: '10月',
				lines: ['北京市昌平区合成生物制造产业集群', '获评全国首个合成生物制造领域', '国家级中小企业特色产业集群'],
			},
			{
				month: '11月',
				lines: ['昌平首家山姆会员店正式开业'],
			...
			{
				month: '11月',
				lines: ['集团联合开发的北京市首个政府侧区域级', '能碳监测管理平台正式上线'],
			},
			{
				month: '12月',
	...
	2026: {
		...
		events: [
			{
				month: '3月',
				lines: ['未来科学城能源谷首座“第四代好房子”', '未来城·星寰时代正式亮相并开放样板间'],
			},
			{
				month: '5月',
			...
			{
				month: '7月',
				lines: ['全国高校合成生物区域技术转移转化中心', '（北京）正式获教育部批复建设'],
			},
			{
				month: '7月',
...
const animateActiveEvents = async () => {
	...
	if (!panel || !track || !parts?.length || !background || !wash || !headingParts?.length || !headingHighlight || !headingTitle || !headingSubtitle) return
	...
	animationContext?.add(() => {
		...
		eventTimeline.addLabel('events', revealStart).fromTo(
			parts,
